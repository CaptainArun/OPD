...
export class MasterBillingPaymentComponent implements OnInit {
  ...
  @ViewChild('BillType', { static: true }) BillType: any;
  disableSave: boolean = false;
  //#region "constructor"
  constructor(private fb: FormBuilder, private billingService: billingService, private VisitPaymentService: VisitService, public customhttp: CustomHttpService, public dialog: MatDialog, private util: UtilService, public dialogRef: MatDialogRef<MasterBillingPaymentComponent>, @Inject(MAT_DIALOG_DATA) public data: any) {
  }
  //#endregion
        ...
        if (key != null) {
          if (key.length > 2) {
            this.billingService.getAllPatientData(key).then(data => {
              ...
              this.BillingTypeNameData = ["Visit"];
              //} 
            });
          }
          else {

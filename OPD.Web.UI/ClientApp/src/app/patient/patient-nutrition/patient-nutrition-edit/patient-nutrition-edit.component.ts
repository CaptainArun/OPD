...
export class PatientNutritionEditComponent implements OnInit {
  ...
  setNutrition() {
    ...
    this.PatientNutritionForm.get("RecordedBy").setValue(this.data.RecordedBy);
    ...
    this.PatientNutritionForm.get("IntakeCategory").setValue(
      this.data.IntakeCategory
    );
    this.PatientNutritionForm.get("FoodIntakeTypeID").setValue(
      this.data.FoodIntakeTypeID
    );
    this.PatientNutritionForm.get("EatRegularly").setValue(
      this.data.EatRegularly
    );
    this.PatientNutritionForm.get("RegularMeals").setValue(
      this.data.RegularMeals
    );
    this.PatientNutritionForm.get("Carvings").setValue(this.data.Carvings);
    this.PatientNutritionForm.get("DislikedIntake").setValue(
      this.data.DislikedIntake
    );
    this.PatientNutritionForm.get("FoodAllergies").setValue(
      this.data.FoodAllergies
    );
    this.PatientNutritionForm.get("Notes").setValue(this.data.Notes);
    this.PatientNutritionForm.get("FoodName").setValue(this.data.FoodName);
    this.PatientNutritionForm.get("Units").setValue(this.data.Units);
    this.PatientNutritionForm.get("Frequency").setValue(this.data.Frequency);
    this.PatientNutritionForm.get("NutritionNotes").setValue(this.data.NutritionNotes);
  ...
  addUpdateNutrition() {
    ...
    this.patientNutritionModel.NutritionAssessmentID =
      this.data.NutritionAssessmentID;

...
export class cardContainerComponent implements OnInit {
  ...
  @Input('dataForContainer') listData: Array<any> | any;  //list of [] Data
  @Input('configCard') config: FlexCardConfig | any;  //config setup of icons 
  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator | any;  //Paginator 
  ...
  ngOnChanges() {
    ...
    if (this.config && this.listData != null && this.listData != undefined) {
      ...
      let Sampledata = filterHeaderData.forEach((data:any) => {
